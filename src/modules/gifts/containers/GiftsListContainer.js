...
import { fetchCards, fetchCard, fetchCardFilter } from "../../../actions/gift-index";
...
import SearchBoxComponent from "../../common/components/SearchBox";
...
export class GiftsListContainer extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Grid container spacing={0} style={{margin: '15px 5px'}}>
